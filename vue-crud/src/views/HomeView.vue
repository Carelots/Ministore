...
const columns = ref([
{name:'customer_id', align:'center', label:'customer_id',field:'customer_id'},
  {name:'firstname', align:'center', label:'firstname',field:'first_name'},
  {name:'last_name', align:'center', label:'last_name',field:'last_name'},
